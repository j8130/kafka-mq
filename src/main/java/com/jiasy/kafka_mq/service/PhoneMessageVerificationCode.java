...
@Component
public class PhoneMessageVerificationCode {
    ...
    @Value("${phone.accessKeyId:123}")
    String accessKeyId;//你的accessKeyId,参考本文档步骤2
    @Value("${phone.accessKeySecret:123}")
     ...
     * @return
     */
    public SendSmsResponse testPhones(String phoneNumbers, String signName, String templateCode, String param) throws ClientException {
    ...
    //
    //     try {
    //         testPhones = testPhones(phones,"小甜甜","SMS_169903144","{\"code\":\""+random+"\"}");
    //         //接收回执信息
    ...
    //
    //     String testMsg = TestMsg("16636183595");
